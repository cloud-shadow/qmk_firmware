// https://configure.ergodox-ez.com/keyboard_layouts/qvxvzy
// https://configure.ergodox-ez.com/layouts/MnWb/latest/0
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(
    KC_ESCAPE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_APPLICATION,
    KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,MEH_T(KC_NO),
    KC_LCTL,KC_A,KC_S,KC_D,KC_F,KC_G,
    KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,MO(5),
    KC_LALT,KC_LGUI,MO(3),MO(2),MO(1),KC_HOME,KC_END,KC_PGUP,KC_SPACE,MO(4),KC_PGDOWN,
    ...
    KC_DELETE,KC_N,KC_M,KC_COMMA,KC_DOT,CTL_T(KC_SLASH),KC_RSHIFT,
    MO(1),KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_LBRACKET,KC_RBRACKET,KC_BSLASH,KC_QUOTE,MO(6),KC_SPACE),


  [1] = LAYOUT_ergodox(KC_TILD,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F11,KC_GRAVE,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_CAPSLOCK,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_AUDIO_VOL_UP,KC_LANG1,KC_TRANSPARENT,KC_AUDIO_VOL_DOWN,KC_F12,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_SLCK,KC_MS_WH_UP,KC_TRANSPARENT,KC_MS_BTN1,KC_MS_UP,KC_MS_BTN2,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,KC_TRANSPARENT,KC_TRANSPARENT,KC_MS_WH_DOWN,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_HOME,KC_PGDOWN,KC_PGUP,KC_END,KC_WWW_BACK,KC_WWW_FORWARD,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_LANG1),
